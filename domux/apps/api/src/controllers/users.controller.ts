...
import { createAdminSchema, createTenantUserSchema, updateUserActiveSchema } from '../schemas/users.schema';
import * as usersService from '../services/users.service';

export async function listAdminsHandler(_request: FastifyRequest, reply: FastifyReply) {
...
export async function setUserActiveHandler(request: FastifyRequest, reply: FastifyReply) {
...
export async function createTenantUserHandler(request: FastifyRequest, reply: FastifyReply) {
